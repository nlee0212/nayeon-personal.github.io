...
const HINTS = {
  ...
  B: '<b>B안 활성 · 스미냑까지.</b> 9/4는 오션뷰 풀이 있는 Locca, 9/7은 스미냑 KU DE TA — 캣블링 자료가 “선셋 정말 예쁨”으로 꼽은 비치바. 공항 45분이라 18:45에는 일어나야 합니다.'
};
...
if (has('#panel')) {
  ...
  const CHIPS = ['9/7 공항 버퍼 다시 계산해줘', 'A안 B안 중 뭐가 나아?', '비치클럽 예약 문구 영어로',
                 '발리밸리 예방 뭐부터 해야 해?', '기사님 안 오면 어떻게 해?', '9/4 하루 어떻게 보내?'];
